...
1. [jQuery]() *Not for long* :laughing:
2. [DateJust.js]()
3. [DateRange.js]()
...
- Include [jQuery]()
- Include [CSS]() and [JavaScript]() from [DateJust.js]()
- Include [CSS]() and [JavaScript]() from [DateRange.js]()
- Include [CSS]() and [JavaScript]() from [Sift.js]() after the above ^
...
## List Configuration
*Additional configuration options when [type](#type) is either "checkbox" or "radio"*
...
## Calendar Configuration
*Additional configuration options when [type](#type) is either "calendar" or "multi_calendar"*
...
- **Usage:**
  ...
  When [type](#type) is "calendar" calendarOptions supports all of the configuration options [DateJust.js]() has:
  ...
  When [type](#type) is "multi_calendar" calendarOptions supports all of the configuration options [DateRange.js]() has:
...
- **Arguments:**
  ...
  When [type](#type) is "checkbox" or "radio" ...args is: `(activeFilter)`.

  When [type](#type) is "calendar" ...args can be: `(singleDate)` or `(startDate, endDate)`.

  When [type](#type) is "multi_calendar" ...args is: `(startDate, endDate)`.
...
The HTML generated by Sift depends on option [type](#type).
